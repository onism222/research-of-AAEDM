...
real_delta = xlsread('Covid19.xlsx',1, 'E28 : E57'); % real daily increase number 2.21 - 3.21
real_delta = reshape(real_delta, 1, length(real_delta));

real_C = xlsread('Covid19.xlsx',1, 'G28 : G57'); % real daily cured number 2.21 - 3.21
...
title('Korea kappa and zeta from 2.21 to 3.21')
